        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="space-y-1 pb-4">
            ...
            <div className="pt-2 text-center">
              <span className="inline-flex items-center gap-1.5 bg-primary/10 text-primary text-xs px-3 py-1 rounded-full font-medium">
                Demo Account: demo@taskflow.com &bull; password123
              </span>
            </div>
          </CardHeader>
          <CardContent>
